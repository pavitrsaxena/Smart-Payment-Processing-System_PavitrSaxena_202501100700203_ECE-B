#PavitrSaxena-202501100700203-ECE-B
...
print(f"Final Amount Paid: ₹{self.final_amount:.2f}")print("-" * 30 + "\n")
...
if cashback > 0:
print(f"** Cashback of ₹{cashback} applied! **")self.generate_receipt()
...
print(f"Transaction Failed: Insufficient balance. Attempted: ₹{amount}, Available:
₹{self.balance}\n")
else:
self.balance -= amount
...
process_payment(upi_user, 1200) # UPI: Gets ₹50 cashback (amount >
1000)process_payment(upi_user, 800) # UPI: No cashback (amount < 1000)
